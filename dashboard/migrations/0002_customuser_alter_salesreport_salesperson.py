    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('sales_clerk', 'Sales Clerk')], default='sales_clerk', max_length=20)),
        ...
        migrations.AlterField(
            ...
            name='salesperson',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.customuser'),
        ),
    ]
